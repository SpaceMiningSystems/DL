        ...
        private void OnInspectorGUI_Renderer()
        {
            ...
            */
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                ...
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_castShadows"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_receiveShadows"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_useLightProbes"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_reflextionProbesUsage"));
                if (m_tilemap.ReflectionProbes != UnityEngine.Rendering.ReflectionProbeUsage.Off)
                {
                    EditorGUI.indentLevel += 2;
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("m_anchorOverride"));
                    EditorGUI.indentLevel -= 2;
                }
                if (EditorGUI.EndChangeCheck())
                {
                    serializedObject.ApplyModifiedProperties();
                    m_tilemap.UpdateRenderProperties();
                }
