...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public partial class TilemapChunk : MonoBehaviour
    {
        ...
        {
            m_meshRenderer.shadowCastingMode = ParentTilemap.CastShadows;
            m_meshRenderer.receiveShadows = ParentTilemap.ReceiveShadows;
#if UNITY_5_4_OR_NEWER
            m_meshRenderer.lightProbeUsage = ParentTilemap.UseLightProbes;
#else
            m_meshRenderer.useLightProbes = ParentTilemap.UseLightProbes;
#endif
            m_meshRenderer.reflectionProbeUsage = ParentTilemap.ReflectionProbes;
            m_meshRenderer.probeAnchor = ParentTilemap.AnchorOverride;
        }
